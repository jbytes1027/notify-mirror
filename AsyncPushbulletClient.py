...
from RemoteNotificationManager import RemoteNotificationClient
...
class AsyncPushbulletClient(RemoteNotificationClient):
    def __init__(self, api_key):
        ...
        # TODO get user and test pb connection
